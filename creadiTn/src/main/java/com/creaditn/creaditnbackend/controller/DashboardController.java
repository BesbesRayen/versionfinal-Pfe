...
public class DashboardController {
    ...
    public ResponseEntity<DashboardResponse> getDashboard(@RequestParam Long userId) {
        ...
        DashboardResponse response = DashboardResponse.builder()
                ...
                .buyingPowerLimit(balance.getBuyingPowerLimit())
                .baseBuyingPower(balance.getBaseBuyingPower())
                .paymentTrustBonus(balance.getPaymentTrustBonus())
                .outstandingBalance(balance.getOutstandingBalance())
                .usedPercent(balance.getUsedPercent())
                .nextInstallmentAmount(balance.getNextInstallmentAmount())
                .nextInstallmentDate(balance.getNextInstallmentDate())
